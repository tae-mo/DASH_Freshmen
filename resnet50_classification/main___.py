...
parser.add_argument('--epoch', default=50, type=int, help='Total epochs to train the model')
parser.add_argument('--save_every', default=1, type=int, help='How often to save a snapshot')
parser.add_argument('--batch_size', default=64, type=int, help='Input batch size on each device')
...
parser.add_argument('--snapshot_path_acc', '-sna', required=False, default='/home/syon1203/DASH_Freshmen/resnet50_classification/snapshot_acc_2.pt', help='Root of Saved Path')
parser.add_argument('--snapshot_path_loss', '-snl', required=False, default='/home/syon1203/DASH_Freshmen/resnet50_classification/snapshot_loss_2.pt', help='Root of Saved Path')
...
def main(rank, batch_size: int, world_size):
    ...
    if args.load_model:
        ...
        checkpoint = torch.load(args.snapshot_path_acc)
